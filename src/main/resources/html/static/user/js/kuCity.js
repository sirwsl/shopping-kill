 ...
 * http://github.com/callmeJozo/kuCity
 *
    ...
    KuCity.prototype = {
        ...
        inputSearch: function() {
            ...
            function search(e) {
                ...
                var value = $(this).val();
                if (value) {
                    var url = 'http://sjipiao.alitrip.com/city_search.do?_ksTS=1439362066383_11337&lines=10&_input_charset=utf-8&needProvince=true&q=' + value;
                    $.ajax({
                        url: url,
                        type: 'get',
                        dataType: 'jsonp'
