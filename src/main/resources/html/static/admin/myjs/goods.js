...
$(function() {
	var a = $("#typeName").val();
	$.ajax({
		url: "http://localhost/admin/getTypesAll/v1",
		dataType: "json",
		type: "GET",
		async: true,
		data: {
...
function goods(e, d, f) {
	...
	$("#goods").bootstrapTable({
		method: "get",
		url: "http://localhost/admin/getGoods/v1",
		dataType: "json",
		headers: {
			"Authorization": $.cookie("token")
		},
...
function delGoods(a) {
	...
	if (b == true) {
		$.ajax({
			url: "http://localhost/admin/delGoodsById/v1",
			data: {
				id: a
			},
			type: "delete",
...
$("#addGoods").click(function() {
	url = "http://localhost/admin/addGoods/v1";
	method = "POST"
});
function setValue(d, b) {
	...
	url = "http://localhost/admin/updateGoods/v1";
	method = "PUT"
}
$("#sub").click(function() {
...
function shelf(a) {
	$.ajax({
		type: "PUT",
		url: "http://localhost/admin/merchandise/v1",
		data: {
			id: a
		},
		dataType: "json",
