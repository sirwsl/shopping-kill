...
$("#addGoods").click(function() {
	...
	if (index) {
		$.ajax({
			type: "get",
			url: "http://localhost/admin/getAllGoodsName/v1",
			data: {
				"status": 1
			},
			dataType: "json",
...
function logger(d, a) {
	...
	$("#sku").bootstrapTable({
		method: "get",
		url: "http://localhost/admin/getSkuAll/v1",
		dataType: "json",
		headers: {
			"Authorization": $.cookie("token")
		},
...
function delActivity(b) {
	...
	if (a == true) {
		$.ajax({
			url: "http://localhost/admin/delSkuById/v1",
			data: {
				id: b
			},
			type: "delete",
...
$("#sub").click(function() {
	...
	$.ajax({
		type: "post",
		url: "http://localhost/admin/updateSkuInfo/v1",
		data: a,
		contentType: false,
		processData: false,
		dataType: "json",
...
$("#subs").click(function() {
	...
	$.ajax({
		type: "post",
		url: "http://localhost/admin/addSkuInfo/v1",
		data: a,
		contentType: false,
		processData: false,
		dataType: "json",
