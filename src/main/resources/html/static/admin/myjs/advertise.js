...
$("#sub").click(function() {
	var a = "http://localhost/admin/addAdvertise/v1";
	if (flag) {
		a = "http://localhost/admin/updateAdvertise/v1";
		flag = false
	}
...
function col(b) {
	var a;
	if (b == 0) {
		a = "http://localhost/admin/getAdvertiseAll/v1"
	} else {
		if (b == 1) {
			a = "http://localhost/admin/getAdvertiseBegin/v1"
		} else {
			if (b == 2) {
				a = "http://localhost/admin/getAdvertiseDoing/v1"
			} else {
				if (b == 3) {
					a = "http://localhost/admin/getAdvertiseOver/v1"
				}
			}
		}
	}
...
$(function() {
	var a = "http://localhost/admin/getAdvertiseAll/v1";
	dev(a)
});
function dev(a) {
...
function del(a) {
	...
	if (b == true) {
		$.ajax({
			type: "delete",
			url: "http://localhost/admin/delAdvertise/v1",
			data: {
				"id": a
			},
			dateType: "json",
