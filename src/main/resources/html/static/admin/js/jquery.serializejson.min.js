/*!
  ...
  http://github.com/marioizquierdo/jquery.serializeJSON
            ...
            $uncheckedCheckboxes.each(function (_i, el) {
                ...
                if (uncheckedValue != null) {
                    if (el.name && el.name.indexOf("[][") !== -1) { // identify a non-supported
                        throw new Error("serializeJSON ERROR: checkbox unchecked values are not supported on nested arrays of objects like '"+el.name+"'. See http://github.com/marioizquierdo/jquery.serializeJSON/issues/67");
                    }
