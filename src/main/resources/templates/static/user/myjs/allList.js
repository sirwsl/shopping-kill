		...
		$(function(){
			$.get('https://test.wslhome.top/api/getRecommendedGoods/v1',{'size':'4'},function(msg){
				if (msg.code == 0){
					var html = '';
			...
			$.get("https://test.wslhome.top/api/getAllGoods/v1", {'current':'1'},
			  function(msg){
				 var html='';
		...
		function addcart(id){
			var msg = "请确认是否添加进您的收藏夹"; 
			 ...
			 $.post("https://test.wslhome.top/user/addCart/v1", {"skuId":skuId,"num":"1"},function(msg) {
			   alert(msg.data);
			 });
			 }else{ 
			  return false; 
