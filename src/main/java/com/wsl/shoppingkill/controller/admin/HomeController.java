...
public class HomeController {
    ...
    public Result<Map<String, IPage<Loggers>>> getLoggersAll(@RequestParam(defaultValue = "1") Long current1, @RequestParam(defaultValue = "20") Long size1,
                                                             @RequestParam(defaultValue = "1") Long current2, @RequestParam(defaultValue = "20") Long size2) {
