...
CREATE TABLE `t_advertise` (
  ...
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='广告内容';
...
CREATE TABLE `t_limit_list` (
  ...
  `del_flag` tinyint(1) DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='黑名单与白名单';
...
CREATE TABLE `t_loggers` (
  ...
  `detail` varchar(999) DEFAULT NULL COMMENT '操作内容',
